...
--Section					Changes
--Return to position on Death			Fixed Slow Death Return 
--Stats ESP					Added Body Toughness Stat ESP
--Spawn Check					Added Only Load Scripts When Player Is Spawned
--Anti Dev/Admin/Mod				Added Anti Dev/Admin/Mod

--Exist Bugs
--ESP Randomly Don't Work


--Spawn Check--

local spawncheck = game:GetService("Players").LocalPlayer
repeat wait() until spawncheck.Character
...
print("Anti Dev/Admin/Mod Executed")

local Target = {
--      [UserId]	"Message",
	[107288341] = "@Sathopian JOINED MY NIGGA",
	[696224584] = "@SirZellek1994 Admin Joined",
	[64236427] = "@Y499 Moderater Joined",
	[1809938170] = "@Iogicalprocess Moderater Joined",
}

Plrs.PlayerAdded:Connect(function(player) -- Check If Player Joined Is The Target
	if Target[player.UserId] then
		plr:Kick(Target[player.UserId])
	end
end)

for i,v in pairs(Plrs:GetChildren()) do -- Check If Target Is In The Server
	if Target[v.UserId] then
		plr:Kick(Target[v.UserId])
	end
end
...
function CreateESP(plr)
	if plr ~= nil then
		...
		bb.AlwaysOnTop = true
		bb.Size = UDim2.new(0, 5, 0, 5) -- Changes To Fit Body Stats og = (0, 5, 0, 5)
		...
		frame.Size = UDim2.new(1, 0, 0, 6) -- Changes, (0, 30, 0, 'SlotNumber') Perfect And No Huge Offset
		...
		TxtDist.Position = UDim2.new(0, 0, 0, -44)
		...
		TxtHealth.Position = UDim2.new(0, 0, 0, -34)
		TxtHealth.Size = UDim2.new(1, 0, 10, 0)
		TxtHealth.Font = "SourceSansBold"
		TxtHealth.TextColor3 = Color3.fromRGB(0, 128, 0)
		...
		TxtFist.Position = UDim2.new(0, 0, 0, -24)
		TxtFist.Size = UDim2.new(1, 0, 10, 0)
		TxtFist.Font = "SourceSansBold"
		TxtFist.TextColor3 = Color3.fromRGB(255, 0, 0)
		TxtFist.TextSize = 15
		TxtFist.TextStrokeTransparency = 0.5
		
		local TxtBody = Instance.new("TextLabel", frame)  -- Changes Start
		TxtBody.Name = "Body"
		TxtBody.ZIndex = 10
		TxtBody.Text = ""
		TxtBody.BackgroundTransparency = 1
		TxtBody.Position = UDim2.new(0, 0, 0, -14) -- Fuck
		TxtBody.Size = UDim2.new(1, 0, 10, 0)
		TxtBody.Font = "SourceSansBold"
		TxtBody.TextColor3 = Color3.fromRGB(252, 93, 61)
		TxtBody.TextSize = 15
		TxtBody.TextStrokeTransparency = 0.5 -- Changes End
		...
		TxtPsychic.Position = UDim2.new(0, 0, 0, -4) -- Last One Must Be '-5' Or It Won't Show (30min Wasted)
		TxtPsychic.Size = UDim2.new(1, 0, 10, 0)
		TxtPsychic.Font = "SourceSansBold"
		TxtPsychic.TextColor3 = Color3.fromRGB(87, 164, 255)
...
function UpdateESP(plr)
	...
	if Find then
		...
		Find.Frame.Health.TextColor3 = Color3.fromRGB(0, 128, 0)
		Find.Frame.Fist.TextColor3 = Color3.fromRGB(255, 0, 0)
		Find.Frame.Body.TextColor3 = Color3.fromRGB(252, 93, 61) -- Changes
		Find.Frame.Psychic.TextColor3 = Color3.fromRGB(87, 164, 255)
		local GetChar = plr.Character
		if MyChar and GetChar then
			...
			if Find2 and Find3 then
				...
				if Dist > ESPLength then
					...
					Find.Frame.Body.Visible = false -- Changes
					...
					Find.Frame.Body.Visible = true -- Changes
				...
				if Find4 then
					...
					Find.Frame.Body.Text = "Body: " ..converttoletter(string.format("%.0f", game.Players[plr.Name].PrivateStats.BodyToughness.Value)) -- Changes
